...
function consultarSucursal(){
    ...
    if(urlParams.indexOf("app-gex") >= 0 || urlParams.indexOf("APP-GEX") >= 0 ){  
        sessionStorage.setItem("exitoSucursal","8185-APPGEX");
        netactica_branch_codeNew = "8185-APPGEX";
    }
    else if(urlParams.indexOf("facebook-ads") >= 0){  
        sessionStorage.setItem("exitoSucursal","8185-Facebook");
        netactica_branch_codeNew = "8185-Facebook";
    }
    else if(urlParams.indexOf("google-ads")   >= 0){  
        sessionStorage.setItem("exitoSucursal","8185-Google");
        netactica_branch_codeNew = "8185-Google";
    }
    else{
        sessionStorage.setItem("exitoSucursal","8185");  
        netactica_branch_codeNew = "8185";
    }
